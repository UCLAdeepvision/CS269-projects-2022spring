...
{: style="width: 800px; max-width: 100%;"}
*Fig 13: Image with white space border generates code that does not compile.*
...
{: style="width: 800px; max-width: 100%;"}
*Fig 14: Multicolumn entry in image did not get detected, see circled in red.*
...
{: style="width: 800px; max-width: 100%;"}
*Fig 15: Image with multiline rows does not get output correctly.*
